      ...
      >
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950">
          <div className="mb-3 px-2">
            <span className="block text-[10px] text-slate-500 uppercase tracking-widest font-mono">AKREDITASI AKSES KEAMANAN</span>
            <div className="mt-1.5 bg-slate-900/60 py-2 px-3.5 rounded-lg border border-slate-800 flex items-center justify-between">
              <span className="text-[10px] text-slate-400 font-mono font-bold uppercase tracking-wider">Level Akses</span>
              <span className="text-[9.5px] font-black bg-red-600/25 border border-red-500/30 text-red-500 px-2.5 py-0.5 rounded uppercase tracking-widest font-mono font-bold">
                {activeRole}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 p-2 bg-slate-900 rounded-xl border border-slate-800">
            <div className="relative">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-red-650 to-red-800 bg-red-600 flex items-center justify-center font-black text-sm text-white border-2 border-slate-800 shadow-md">
                {currentUser?.avatar || 'RW'}
              </div>
              <span className="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-emerald-400 border border-slate-900 animate-pulse" />
            </div>
            <div className="overflow-hidden">
              <span className="block text-xs font-bold text-white truncate">{currentUser?.name || "Radit's Admin"}</span>
              <span className="block text-[10.5px] text-red-500 font-medium truncate mt-0.5">{activeRole}</span>
            </div>
